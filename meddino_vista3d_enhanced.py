"""
MedDINO-VISTA3D Enhanced with U-Net Decoder
==============================================

PHASE 1 ENHANCEMENTS:
- Multi-scale skip connections from DINOv2 layers
- Progressive 4-stage upsampling decoder
- Spatial attention at decoder
- Tversky + Focal hybrid loss (cyst-aggressive)
- 50% cyst-focused sampling

Architecture:
- Encoder: DINOv2 (ViT-B/14) with multi-scale feature extraction
- Decoder: U-Net style with skip connections + attention
- Loss: Tversky (α=0.15, β=0.85) + Focal + Dice
- VISTA3D Compatible: Ready for future LLM expert integration

Usage:
    # Quick Test
    python meddino_vista3d_enhanced.py --mode quick_test
    
    # Full Training
    python meddino_vista3d_enhanced.py --mode full
"""
...
def get_config(mode):
    ...
    base = {
        ...
        "output_dir": "./output/meddino_vista3d_enhanced",
...
def train(config):
    print("=" * 70)
    print("MedDINO-VISTA3D ENHANCED (Phase 1)")
    print("Features: Multi-scale skip connections + U-Net decoder + Aggressive cyst loss")
