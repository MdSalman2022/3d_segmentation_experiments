...
Usage:
    python kits23_attention_unet_v3.py --mode train
    python kits23_attention_unet_v3.py --mode train --quick
    python kits23_attention_unet_v3.py --mode inference
    python kits23_attention_unet_v3.py --mode evaluate
"""
...
CONFIG = {
    ...
    # Output paths
    "output_dir": "./output/kits23_attention_unet_v3",
    "checkpoint_dir": "./output/kits23_attention_unet_v3/checkpoints",
    "predictions_dir": "./output/kits23_attention_unet_v3/predictions",
    "visualizations_dir": "./output/kits23_attention_unet_v3/visualizations",
    ...
    "training": {
        "num_epochs": 200,
        "quick_epochs": 5,  # More epochs for quick test
        "batch_size": 1,  # Use the 10GB headroom
